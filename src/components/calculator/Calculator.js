      ...
      <div className="calculator-container">
        {this.state.showCalculator ?
          <div className="calculator">
            <div className="container price-form-container">
            ...
            {!document.location.pathname.includes("embed") ?
              <div className="row well well-lg marg">
                <div className="about col-xs-12 col-sm-12 col-md-7 center-block textColor">
                  <p className={"col-md-6 textColor" + (this.props.bodyFont || "")}>
                    Most Nigerians struggle to afford medicines, both locally made and imported.
                    ...
                    workers earn, on the average, just US$1.4 per day.
                  </p>
                  <p className={"col-md-6 textColor " + (this.props.bodyFont || "")}>
                    ...
                    on just how expensive medicine is and asks why Nigerians pays more
